...
card_amounts = (123.56, 876.87, 100.35, 56.77, 45.76, 66.89, 77.00, 202.20, 89.77, 12.89)
card_provider_dict = {}
...
class FakeCreditCardData:
    ...
    def __init__(self, partition_key, card_type, card_num, security_code, trans_amount, trans_ts):
